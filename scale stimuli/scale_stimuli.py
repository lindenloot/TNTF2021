"""
DESCRIPTION:
Rescales scene images such that they all have the same size.
The exact dimensions depend on whether the scene is in landscape
or portrait.

NOTE: the same size is used for both the TNT and the IMDF scenes
"""
...
# Define constants:
# The script assumes that you have four folders in the current
# directory. (The current directory is the directory where your
# Python script is located and ran)

exp = "IMDF"

SRC = "./%s_scenes_raw" % exp# Folder containing original scenes
DST = "./%s_scenes_scaled" % exp# (Empty) destination folder for rescaled images
